...
export const getInitialMatchups = async ({ currentRound }) => {
...
// export const addUserSelectionsToRounds = async ({ matchups, bracketId }) => {
//   const res = await fetch('/api/airtable/add-user-selections-to-rounds', {
//     method: 'POST',
//     headers: {
//       'Content-Type': 'application/json',
//     },
//     body: JSON.stringify({ matchups, bracketId }),
//   }).then(res => res.json());
//   return res;
// };
